					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +91-9479592970</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i>info@app-techsolutions.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://www.facebook.com/apptechsolutionspcm"><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://www.twitter.com/parvezkhanats"><i class="fa fa-twitter"></i></a></li>
								<li><a href="https://www.linkedin.com/company/app-tech-solutions-pach/?viewAsMember=true"><i class="fa fa-linkedin"></i></a></li>
								<li><a href="https://www.instagram.com/parvezkhanats"><i class="fa fa-instagram"></i></a></li>
								<li><a href="https://www.youtube.com/channel/UCmfYHxoEsVKu6l1HQBcIYHA"><i class="fa fa-youtube"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="address">
							...
							<p>Near Cariappa Park, Government College, Pachmarhi, Madhya Pradesh, 461881(India)</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Develop by <span><a target="_blank" href="https://github.com/parvezkhanats">Parvez Khan</a></span></p>
				</div>
			</div>
		</div>
